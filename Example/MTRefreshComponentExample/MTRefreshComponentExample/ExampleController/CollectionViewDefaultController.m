//
//  CollectionViewDefaultController.m
...
@interface CollectionViewDefaultController ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation CollectionViewDefaultController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.navigationItem.title = @"Collection Default";
    ...
    [self.collection addTopRefreshWithTriggerBlock:^{
